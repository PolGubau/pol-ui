...
const falsey: unknown[] = [, null, undefined, false, 0, Number.NaN, ""];
const empties = [[], {}].concat(falsey.slice(1));
const patternMatcher = /x/;
...
describe("get", () => {
  ...
  it("should preserve the sign of `0`", () => {
    ...
    const props: any[] = [-0, new Object(-0), 0, new Object(0)];
  ...
  it("should return the default value for `undefined` values", () => {
    const object = { a: {} };
    const values = empties.concat(true, new Date(), 1, patternMatcher, "a");
