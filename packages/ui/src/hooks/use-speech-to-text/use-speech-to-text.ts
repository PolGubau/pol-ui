...
const useSpeechToText = ({
  ...
  const hasWindowOrWebkitSpeechRecognition =
    hasWindowSpeechRecognition || hasWebkitSpeechRecognition
  ...
  const recognition: ISpeechRecognition | null =
    hasWindow && hasWindowOrWebkitSpeechRecognition
      ? new windowOrWebkitSpeechRecognition()
      : null
