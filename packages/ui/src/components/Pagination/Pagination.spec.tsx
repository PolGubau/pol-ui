...
const PaginationTestFiveElements: FC = () => {
  ...
  return <Pagination currentPage={page} onPageChange={onPageChange} showIcons={true} totalPages={5} />;
};
...
const PaginationTestTenElements: FC = () => {
  ...
  return <Pagination currentPage={page} onPageChange={onPageChange} showIcons={true} totalPages={10} />;
};
