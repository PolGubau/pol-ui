...
describe("Pagination", () => {
  ...
  it("should render correctly with given props", () => {
    renderWithProviders(<Pagination total={100} page={2} onPageChange={mockOnPageChange} pageSize={10} />);
  ...
  it("should disable previous button on the first page", () => {
    renderWithProviders(<Pagination total={100} page={0} onPageChange={mockOnPageChange} pageSize={10} />);
  ...
  it("should correctly calculate pagination details", () => {
    renderWithProviders(<Pagination total={100} page={3} onPageChange={mockOnPageChange} pageSize={10} />);
  ...
  it("should call onPageChange with correct page number when page buttons are clicked", () => {
    renderWithProviders(<Pagination total={100} page={1} onPageChange={mockOnPageChange} pageSize={10} />);
