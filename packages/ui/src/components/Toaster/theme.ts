...
export const toastTheme: ToastTheme = {
  ...
  success:
    "bg-success-50 dark:bg-success-900 text-success-900 dark:text-success-50",
  //
  ...
  //
  warning:
    "bg-warning-50 dark:bg-warning-900 text-warning-900 dark:text-warning-50",

  //
  loading:
    "bg-secondary-50 dark:bg-secondary-900 text-secondary-900 dark:text-secondary-50",
