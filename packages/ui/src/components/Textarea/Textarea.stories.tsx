...
/**
 * By default has a max-height of 192px, this is to prevent the textarea from taking up too much space. If you want to increase the height of the textarea, you can add a min-height to the classname prop or disable the max-height by setting it to max-h-full
 */
export const Higher: Story = Template.bind({});
Higher.args = {
	label: "Username",
	className: "max-h-full h-[500px]",
};
