...
export const ContainedMode = (args: TabsProps): React.ReactNode =>
	TabsExample.bind({})(args);
ContainedMode.args = {
	tabs: tabs,
	mode: "contained",
};

export const WithoutAnyMotion = (args: TabsProps): React.ReactNode =>
	TabsExample.bind({})(args);
...
export const Disabled = (args: TabsProps): React.ReactNode =>
	TabsExample.bind({})(args);
Disabled.args = {
	tabs: [
		{
			...
			content: (
				<div className="bg-background-onPrimary p-6 rounded-2xl">
					...
					<p>
						Lorem ipsum dolor sit amet consecte tur adipisicing elit. Ipsam,
						quas. Lorem ipsum dolor sit amet consecte tur adipisicing elit.
						Ipsam, quas. Lorem ipsum dolor sit amet consecte tur adipisicing
						elit. Ipsam, quas. Lorem ipsum dolor sit amet consecte tur
						adipisicing elit. Ipsam, quas. Lorem ipsum dolor sit amet consecte
						tur
					</p>
				</div>
			),
		},
		{
			...
			content: (
				<div className="bg-background-onPrimary p-6 rounded-2xl">
					<h2 className="text-3xl text-secondary-900 font-bold">
						Disabled Tab
					</h2>
					<p>
						Lorem ipsum dolor sit amet consecte tur adipisicing elit. Ipsam,
