    ...
    <Conveyor duration={30}>
      {testimonials.map((testimonial) => (
        <Card key={testimonial.name} className="w-[350px] flex flex-col gap-4">
          <Rating stars={5} filled={testimonial.stars} starClassName="fill-secondary" />
...
export const Words = (args: ConveyorProps): React.ReactNode => {
  return (
    <Conveyor {...args} className="bg-secondary-900 text-secondary-50 flex items-center justify-center">
...
export const Stress = (): React.ReactNode => {
  return (
    <Conveyor className="flex items-center justify-center" duration={2} renders={20}>
