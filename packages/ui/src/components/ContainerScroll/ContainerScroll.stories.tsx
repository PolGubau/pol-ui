...
const Template: StoryFn<ContainerScrollProps> = (args) => (
  <ContainerScroll {...args} />
)
...
const cards = (
  <div className="flex items-center gap-4 flex-col justify-center w-full ">
    {[1, 2, 3, 4, 5, 6].map((n) => {
      return (
        <div
          className="w-fit h-fit bg-gray-300 dark:bg-gray-800 rounded-lg shadow-lg"
          key={n}
        >
          <div className="p-4">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              ...
              vehicula, nisl et aliquam cursus, ligula ante auctor nulla, at
              accumsan ex leo in enim.
            </p>
          </div>
        </div>
      )
