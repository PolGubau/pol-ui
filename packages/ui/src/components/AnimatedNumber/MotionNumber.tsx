// based on https://github.com/barvian/motion-number
...
import JustifiedAnimatePresence, {
  type Justify,
} from "./JustifiedAnimatePresence"
    ...
    switch (type) {
      ...
      case "fraction":
        fraction.push(
          ...part.value
            .split("")
            .map((d) => ({ type, value: parseInt(d), key: generateKey(type) }))
        )
        break
      // case 'nan':
      // case 'infinity':
...
>(function MotionNumber(
  ...
  const { transition: motionConfigTransition } =
        ...
        >
          ...
          >
            ...
            >
              ...
              <Section
                data-motion-number-part="fraction"
                layout="position"
                parts={fraction}
              />
            </motion.span>
