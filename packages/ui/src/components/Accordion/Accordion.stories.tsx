...
const Template: StoryFn<AccordionProps> = (args) => (
	<Accordion arrowIcon={icon} {...args}>
		<Accordion.Panel>
			...
			<Accordion.Content>
				<p>
					This content is a div by default, but you can place inside any other
					component you like, for example, this p tag.
				</p>
				<p>
					As we use tailwind, you can style this accordion however you like. For
					example, you can add a border to the content.
				</p>
				<p className="mt-2 w-fit rounded-xl border border-green-400 bg-green-200 px-2 py-1">
					You see :)
				</p>
			</Accordion.Content>
		</Accordion.Panel>
		<Accordion.Panel>
			<Accordion.Title as={HeadingLevelEnum.h3}>
			...
			>
				<p>
					No problem, you can use the theme prop to style the accordion. You can
					also use the theme prop to override the default classes.
				</p>
		...
		<Accordion.Panel>
			...
			<Accordion.Content>
				...
				<ol className="flex w-fit flex-col gap-2 divide-y">
					<li>
						<strong>alwaysOpen</strong> - if true, the accordion will always be
						open
					</li>
					<li>
