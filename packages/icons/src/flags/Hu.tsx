...
function SvgHu(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      />
      <path
        d="M57.577 31.82v4.12c0 3.309-.344 4.509-.991 5.719a6.746 6.746 0 01-2.807 2.806c-1.21.647-2.41.992-5.72.992H14.065c-3.31 0-4.51-.345-5.719-.992a6.745 6.745 0 01-2.807-2.806c-.647-1.21-.991-2.41-.991-5.72V31.82h53.03z"
        fill="#8FD130"
      />
      <path
        d="M14.064 4.55H48.06c3.31 0 4.51.345 5.72.992a6.746 6.746 0 012.806 2.807c.647 1.21.991 2.41.991 5.72v4.118H4.547v-4.119c0-3.31.344-4.51.992-5.72a6.746 6.746 0 012.806-2.806c1.21-.647 2.41-.991 5.72-.991z"
        fill="#F73030"
      />
    </svg>
  );
