	...
	return (
		<Listbox value={selected} onChange={handleChanges}>
			<div className="relative">
				...
				>
					<Listbox.Options
						className={`absolute mt-1 max-h-60 w-fit overflow-auto rounded-md bg-white py-1 bg-background dark:bg-background-inverted text-background-inverted dark:text-background text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm z-50 `}
					>
						{items.map((person) => {
