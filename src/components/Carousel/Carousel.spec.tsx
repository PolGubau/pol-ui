...
const TestCarousel: FC<CarouselProps> = props => (
  <Carousel {...props}>
    <img alt="" src="https://polgubau.com/docs/images/carousel/carousel-1.svg" height="100" width="100" />
    <img alt="" src="https://polgubau.com/docs/images/carousel/carousel-2.svg" height="100" width="100" />
    <img alt="" src="https://polgubau.com/docs/images/carousel/carousel-3.svg" height="100" width="100" />
    <img alt="" src="https://polgubau.com/docs/images/carousel/carousel-4.svg" height="100" width="100" />
    <img alt="" src="https://polgubau.com/docs/images/carousel/carousel-5.svg" height="100" width="100" />
  </Carousel>
)
