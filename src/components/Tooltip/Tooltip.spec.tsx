...
describe('Tooltip Component', () => {
  ...
  it('opens and closes the tooltip with controlled props', async () => {
    ...
    const { rerender } = render(
      <Tooltip content="Tooltip content 1" open={false} onOpenChange={onOpenChange}>
        <button>Hover me</button>
      </Tooltip>,
    )
    ...
    rerender(
      <Tooltip content="Tooltip content 2" open={true} onOpenChange={onOpenChange}>
        <button>Hover me</button>
      </Tooltip>,
    )
    ...
    rerender(
      <Tooltip content="Tooltip content 3" open={false} onOpenChange={onOpenChange}>
        <button>Hover me</button>
      </Tooltip>,
    )
  ...
  it('applies custom theme styles', async () => {
    ...
    render(
      <Tooltip content="Tooltip content" theme={customTheme}>
        <button>Hover me</button>
      </Tooltip>,
    )
