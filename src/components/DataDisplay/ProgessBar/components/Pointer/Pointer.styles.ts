...
export const pointerPB = ({ pointerPosition = "top" }: Props) => {
	const base =
		"absolute  p-1 transform -translate-x-1/2 w-8 h-5 z-10 bg-primary text-background dark:text-background-inverted text-xs flex items-center justify-center rounded-md";
