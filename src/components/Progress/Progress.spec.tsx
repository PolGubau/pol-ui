...
const outerLabelContainer = () => screen.getByTestId('ui-progress-label-container')
const outerProgressLabel = () => screen.getByTestId('ui-progress-label-progress')
const outerTextLabel = () => screen.getByTestId('ui-progress-label')
