...
export const commandTheme: CommandTheme = {
  ...
  item: {
    base: 'flex flex-1 w-full relative cursor-pointer select-none items-center px-6 py-3 text-secondary-700 dark:text-secondary-50 text-sm outline-none aria-selected:bg-secondary-400/80 dark:aria-selected:bg-secondary-900/80  aria-selected:text-secondary-900 dark:aria-selected:text-secondary-50',
  },
}
