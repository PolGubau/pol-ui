...
export const containerScrollTheme: ContainerScrollTheme = {
  ...
  container: 'py-20 w-full relative',
  header: 'max-w-5xl mx-auto text-center',

  device:
    'max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-secondary-700 dark:border-secondary-800 p-4 bg-secondary-900 rounded-[30px] shadow-2xl ',
