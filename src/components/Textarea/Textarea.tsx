...
import type { BaseInputsProps  } from '../Input/Input';
...
export const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
  ( {
    ...
    return ( <div className={twMerge(theme.root.base, theme.root.labelPosition[labelPosition])}>
        {label && (
        ...
        <div className={twMerge(theme.base, className)}>
          ...
          className={twMerge(
            ...
            theme.field.input.withRightIcon[rightComponent ? 'on' : 'off'],innerClassName 
          )}
          {...props}
        />
